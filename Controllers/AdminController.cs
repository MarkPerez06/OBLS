...
namespace OBLS.Controllers
{
    public class AdminController : Controller
    {
        ...
        public AdminController(ApplicationDbContext context, ILogger<AdminController> logger, SignInManager<IdentityUser> signInManager)
        {
            _context = context;
            _logger = logger;
        ...
        public IActionResult Index()
        {
            ...
            if (Persons != null)
            {
                ...
                IEnumerable<Persons> model = _context.Persons.OrderByDescending(m => m.Id).Where(m => m.IsAdmin == true).ToList();
